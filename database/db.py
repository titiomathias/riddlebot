...
cur.execute(
    """CREATE TABLE riddles(
        ...
        FOREIGN KEY (first) REFERENCES users(id) ON DELETE SET NULL,
        FOREIGN KEY (second) REFERENCES users(id) ON DELETE SET NULL,
        FOREIGN KEY (third) REFERENCES users(id) ON DELETE SET NULL
    )"""
)
